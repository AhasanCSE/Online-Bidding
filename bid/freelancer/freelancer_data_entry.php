...
<?php
    if(isset($_POST['data_entry_save1'])){
        ...
        $data_entry_idno1 = $_POST['data_entry_idno1'];
        $sql1 = "insert INTO personal_documents (NAME, EMAIL, PHONE, PROFESSION, AGE, ID_NUMBER, CREATED_ON)
            VALUES ('".$data_entry_name1."', '".$data_entry_email1."', '".$data_entry_mobile1."', '".$data_entry_profession1."', '".$data_entry_age1."', '".$data_entry_idno1."', '".$data_entry_date1."')";
...
<?php
    if(isset($_POST['data_entry_save2'])){
            ...
            $sql2 = "insert INTO company_documents (COMPANY_NAME, COMPANY_EMAIL, COMPANY_PHONE, COMPANY_TYPE, CONTACT_PERSON, COMPANY_ADDRESS, COMPANY_WEB_LINK, COMPANY_FB_LINK, CREATED_ON)
...
<div class = "data_entry_div_cls1" id ="data_entry_div_id1">
    <form >
        <div class='form-group' id="choose">
                <input type="radio" name="form_type1" checked id="personal_document" value="personal_document" onclick='f1()'>
                <label for='personal_document' class=''>personal_document</label>
             
               <input type="radio" name="form_type1" id="company_document" value="company_document" onclick='f2()'>
            ...
            <div class="card-body"><h5 class="card-title">Enter Your Personal Information</h5>
                <form class="" action = "" method = "post">
                    <div class="form-row">
                        ...
                        <div class="col-md-6">
                            <div class="position-relative form-group">
                                <label for="data_entry_idno1" class="">NID/PASSPORT No</label>
                                <input name="data_entry_idno1" id="data_entry_idno1" placeholder="Enter your credentials" type="text" class="form-control">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="position-relative form-group">
        ...
        <div class="main-card mb-3 card">
            <div class="card-body"><h5 class="card-title">Enter Your Company Information</h5>
                <form class="" action = "" method = "post">
                    ...
                    <input name = "data_entry_save2" type="submit" class="btn-wide btn-pill btn-shadow btn-hover-shine btn btn-primary btn-lg pull-right" id="data_entry_save2" value="Save">
                </form>
            </div>
        </div>
    </div>
