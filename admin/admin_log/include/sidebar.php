                        ...
                        <ul class="vertical-nav-menu">
                            ...
                            <li
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a href="?pagex=adm_bidding&&root=bidding">
                                            <i class="metismenu-icon">
                                            </i>Bidding
                                        </a>
                                    </li>
                                     <li>
                                        <a href="?pagex=admin_share_setup&&root=shares">
                                            <i class="metismenu-icon">
                                            </i>shares
                                        </a>
                                    </li>
                                    <li>
                                        <a href="?pagex=currency_setup&&root=currency">
                                            <i class="metismenu-icon">
                                            </i>Currency
                                        </a>
                                    </li>
                                    <li>
                                        <a href="?pagex=transaction&&root=bidding">
                                            <i class="metismenu-icon">
                                            </i>Balance Transfer
                                        </a>
                                    </li>
                                     <li>
                                        <a href="?pagex=adm_bidding_rate&&root=bidding">
                                            <i class="metismenu-icon">
                                            </i>Bidding Rate
                                        </a>
                                    </li>
                                    ...
                                    <li>
                                        <a href="?pagex=adm_dividend_share&&root=bidding">
                                            <i class="metismenu-icon">
                                            </i>Divident
                                        </a>
                                    </li>
                                    <li>
                                        <a href="?pagex=adm_lottery_setup&&root=lottery">
                                            <i class="metismenu-icon">
                                            </i>Lottery
                                        </a>
                                    </li>
                                    <li>
                                        <a href="?pagex=adm_freelancer&&root=freelancer">
                                            <i class="metismenu-icon">
                                            </i>Freelancer
                                            <i class="metismenu-state-icon pe-7s-angle-down caret-left"></i>
                                        </a>
                                        ...
                                        <ul>
                                            <li>
                                                <a href="?pagex=adm2_freelancer&&root=freelancer">
                                                    <i class="metismenu-icon">
